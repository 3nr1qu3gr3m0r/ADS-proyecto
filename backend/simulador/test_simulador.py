# ============ PROMPT ============
# Pruebas unitarias con pytest y unittest.mock para SimulacionServicio:
# verifica inicio de simulación, llamada única al motor, guardado de historial,
# navegación de pasos (avanzar/retroceder), pausa/reanudación de fase
# y aislamiento entre múltiples simulaciones concurrentes.
# ======== FIN DEL PROMPT ========
