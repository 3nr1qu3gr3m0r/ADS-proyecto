# ============ PROMPT ============
# Define las entidades del dominio EPiC como dataclasses inmutables con serialización
# JSON: Posicion, Nodo (premisa u operador lógico), Arista, Red, ResultadoPropagacion,
# EstadoSimulacion y ErrorValidacion, con métodos to_dict/from_dict bidireccionales.
# ======== FIN DEL PROMPT ========
