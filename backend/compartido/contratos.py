# ============ PROMPT ============
# Define las interfaces abstractas IMotorCalculo, IMotorCalculoIterativo e ISimulacion
# usando ABC, el enum FaseSimulacion, eventos del dominio como dataclasses
# (RedActualizada, SimulacionIniciada, ErrorCalculo) y excepciones propias del sistema EPiC.
# ======== FIN DEL PROMPT ========
