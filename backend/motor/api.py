# ============ PROMPT ============
# Expone endpoints FastAPI POST /api/v1/redes/{id}/calcular y GET /api/v1/propagaciones/{id}
# que reciben una red en JSON con esquemas Pydantic, validan su estructura,
# ejecutan el motor de tablas EPiC y cachean el resultado en memoria.
# ======== FIN DEL PROMPT ========
