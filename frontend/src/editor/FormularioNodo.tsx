// ============ PROMPT ============
// Implementa un formulario React con toggle premisa/operador: para premisas
// permite elegir valor Belnap (T/F/B/N) con previsualización de color en botones,
// para operadores ofrece selector de AND/OR/XOR/IMP/NOT con descripción,
// e incluye botones de inserción de símbolos lógicos (¬, ∧, ∨, →, etc.) en la etiqueta.
// ======== FIN DEL PROMPT ========
