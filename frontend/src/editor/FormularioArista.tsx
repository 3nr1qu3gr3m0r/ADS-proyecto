// ============ PROMPT ============
// Implementa un formulario React para crear aristas entre nodos de la red EPiC,
// con dropdowns separados para origen (cualquier nodo) y destino (solo operadores),
// aplicando la regla de que las premisas solo pueden ser origen y mostrando
// ayuda contextual para el operador IMP que requiere orden de conexión.
// ======== FIN DEL PROMPT ========
