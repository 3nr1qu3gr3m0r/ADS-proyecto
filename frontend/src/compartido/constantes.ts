// ============ PROMPT ============
// Define las constantes visuales del dominio EPiC: paleta de color por valor Belnap
// (T=verde, F=rojo, B=naranja, N=gris), descripciones textuales, colores del tema
// oscuro del playground y 3 presets de redes de ejemplo (modus-ponens, contradiccion, xor).
// ======== FIN DEL PROMPT ========
