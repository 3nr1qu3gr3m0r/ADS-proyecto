// ============ PROMPT ============
// Implementa el panel de resultados React que muestra métricas de propagación
// (algoritmo usado, número de iteraciones, estado de convergencia), una tabla
// de valores por nodo con indicador de color según Belnap (T/F/B/N) y una leyenda
// explicativa de los 4 valores evidenciales de la lógica EPiC.
// ======== FIN DEL PROMPT ========
